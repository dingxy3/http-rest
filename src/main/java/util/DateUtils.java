...
public class DateUtils
{
     ...
     * @return
     */
    public static int betweenMinute(String time){

        long t =  System.currentTimeMillis()-Long.parseLong(time);
        return Integer.parseInt(String.valueOf(t/(1000*60)));
    }
